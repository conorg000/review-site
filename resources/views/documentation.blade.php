...
@section('content')
  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      ...
      <h2>Pagination</h2>
      <p>Pagination is a handy skill and I'm glad I had the chance to learn it. At first, I couldn't get it to work. After a long period of frustration I found that I was including 
      brackets in my function call when I shoudn't have been. Syntax errors...</p>
      <p>Once I'd learned my lesson, it was quick and easy to paginate all sorts of data.</p>
      <h2>Obstacles</h2>
